...
class Crawler(HttpCaseWithUserDemo):
    ...
    def test_05_test_clean_url(self):
        urls_to_check = [
            ...
            ("/my/page/2/", "/my/page/<slug>"),
            ("/terms", "/terms"),
            ("/controllers/slug-1", "/controllers/<slug>"),
            ("/controllers/tag/slug-2", "/controllers/tag/<slug>"),
            ("/controllers/slug-1/slug-2", "/controllers/<slug>/<slug>"),
            ("/controllers/slug-1/tag/slug-2", "/controllers/<slug>/tag/<slug>"),
            ("/controllers/slug-1/tag/slug-2/end", "/controllers/<slug>/tag/<slug>/end"),
            ("/controllers?tags=%5B5%5D", "/controllers?tags=<param>"),
            ("/controllers?date=upcoming&tags=%5B5%5D", "/controllers?date=<param>&tags=<param>"),
            ("/controllers?tags=%5B%5D&date=upcoming", "/controllers?date=<param>&tags=<param>"),
        ]
        uniq = set()
